...
import 'package:colleagueapp/student/st_previous_tab.dart';
import 'package:colleagueapp/student/st_upcoming_tab.dart';
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        Column(
          children: [
            Expanded(
              child: TabBarView(children: [StUpComingTab(),StPreviousTab()]),
            ),
          ],
        ),
        Align(
