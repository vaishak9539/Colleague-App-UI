...
class AdEventStudentDetails extends StatefulWidget {
  const AdEventStudentDetails({super.key});

  @override
  State<AdEventStudentDetails> createState() => _AdEventStudentDetailsState();
}

class _AdEventStudentDetailsState extends State<AdEventStudentDetails> {
  @override
